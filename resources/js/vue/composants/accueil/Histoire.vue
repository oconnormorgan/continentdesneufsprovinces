<template>
  <v-card class="ma-3 blue-grey lighten-5">
    <v-card-text>
      <v-row>
        <v-col cols="12" md="8">
          <p class="display-1 text--primary">La Genèse</p>
        ...
        <v-col cols="12" md="4">
          <v-card class="mx-auto blue-grey lighten-4">
            <v-card-text>
              <v-avatar color="teal" size="62">
                <span class="white--text headline">PO</span>
              </v-avatar>
              <div>Le premier des Grands</div>
              <p class="display-1 text--primary">Primus OCTAVIA</p>
              <div class="text--primary">
